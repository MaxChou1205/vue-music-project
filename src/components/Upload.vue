<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      ...
      <input ref="fileInput" type="file" multiple @change="upload($event)" />
      <hr class="my-6" />
      <!-- Progess Bars -->
      ...
      files.forEach(file => {
        ...
        task.on(
          ...
          async () => {
            ...
            this.uploads[updateIndex].variant = "bg-green-400";
            this.uploads[updateIndex].icon = "fas fa-check";
            this.uploads[updateIndex].text_class = "text-green-400";
          }
        );
      });
    },
